...
(function (Notificacion) {
    ...
    function fun_main(config) {
        ...
        propiedades.el_g_contenedor = config.el_contenedor_padre.append("g")
    ...
    Notificacion.fun_main = fun_main;
    function init_properties(propiedades) {
        if (!propiedades.prop_config.prop_medida_icono)
            propiedades.prop_config.prop_medida_icono = 110;
        if (propiedades.prop_config.prop_configText === undefined)
            propiedades.prop_config.prop_configText = {};
        if (propiedades.prop_config.prop_configText.prop_color === undefined)
            propiedades.prop_config.prop_configText.prop_color = "#ffffff";
        if (propiedades.prop_config.prop_configText.prop_font_family === undefined)
            propiedades.prop_config.prop_configText.prop_font_family = "Roboto-Light, Roboto";
        if (propiedades.prop_config.prop_configText.prop_size_text === undefined)
            propiedades.prop_config.prop_configText.prop_size_text = 14;
        if (propiedades.prop_config.prop_configText.prop_weight === undefined)
            propiedades.prop_config.prop_configText.prop_weight = "300";
    }
    function fun_dibuja_notificacion(propiedades) {
        propiedades.el_g_contenedor.attr("display", "none").style("opacity", 0)
            .call(Utils_1.D3Utils.eventos.fun_agregar_click, () => { fun_ocultar(propiedades); });
        propiedades.el_rect_background = propiedades.el_g_contenedor.append("rect")
        ...
        propiedades.el_g_contenedor_info = propiedades.el_g_contenedor.append("g");
        propiedades.el_g_contenedor_imagen_tipo = propiedades.el_g_contenedor_info.append("g");
        propiedades.el_texto_mensaje = propiedades.el_g_contenedor_info.append("text")
    ...
    function fun_mostrar(propiedades, mensaje, tipo) {
        ...
        Utils_1.D3Utils.wrap(propiedades.el_texto_mensaje, propiedades.prop_config.width - 10, propiedades.prop_config.prop_configText.prop_size_text, null, null, null, true);
        ...
        if (propiedades.prop_config.fun_callback_mostrar)
            propiedades.prop_config.fun_callback_mostrar();
        propiedades.prop_time_out = setTimeout(() => { fun_ocultar(propiedades); }, 2000);
    }
    function fun_ocultar(propiedades) {
...
})(Notificacion = exports.Notificacion || (exports.Notificacion = {}));
